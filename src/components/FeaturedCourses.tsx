...
import courseData from "../data/music_courese.json";
    ...
    <div className="text-white py-12 bg-gray-900">
      <div>
        <div className="text-center">
          <h2 className=" text-base text-teal-600 font-semibold tracking-wideuppercase">FEATURED COURSES</h2>
            ...
            <div key={course.id} className="flex justify-center">
              <BackgroundGradient className="flex flex-col rounded-[22px] bg-black dark:bg-zinc-900 overflow-hidden h-full max-w-sm   " >
               <div className="p-4 sm:p-6  flex flex-col items-center text-center flex-grow">
                ...
                <Link href={`/corses/${course.slug}`}>Learn More</Link>
               </div>
              </BackgroundGradient>
